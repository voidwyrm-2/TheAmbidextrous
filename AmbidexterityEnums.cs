...
public static class AmbidexterityEnums
{
    ...
    {
        public static SSOracleBehavior.Action MeetAmbidextrous;

        public static Conversation.ID Pebbles_Ambidextrous_FirstMeet = new(nameof(Pebbles_Ambidextrous_FirstMeet), true);
        public static Conversation.ID Pebbles_Ambidextrous_AfterMet = new(nameof(Pebbles_Ambidextrous_AfterMet), true);
